function LambdaSearchPEB(NUM_RUNS, FOLD, GCMDataFile, TargetDataFile, PartitionsDataFile,outputFileName)
    ...
    for run = 1:NUM_RUNS
        ...
        for lambda = lambda_values;
            ...
            for n = 1:FOLD
                ...
                mdl = fitrlinear(TrainModelEP, TargetTrain, 'Regularization', 'Ridge', 'Lambda', lambda);
